## this code computes the B from COG on the L12.2 data, which are not time-interpolated (only deconvolved with the PSF).
# I compute B from 5 wavelength points within the line to compare from those computed from the full data points.
